...
namespace PortugueseApartmentPrice_ML
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\Princcipal\source\repos\PortugueseApartmentPrice-ML\PortugueseApartmentPrice-ML\Datasets\portugal_apartments.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Type", @"Type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.ReplaceMissingValues(@"Area", @"Area"))      
                                    .Append(mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Location",outputColumnName:@"Location"))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Type",@"Area",@"Location"}))      
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=23,NumberOfLeaves=4,FeatureFraction=0.81763613F,LabelColumnName=@"Price",FeatureColumnName=@"Features"}));
